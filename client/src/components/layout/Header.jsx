  ...
  return (
    <header className="flex w-full items-center justify-between bg-neutral-300 z-20 dark:bg-black px-6 py-3 font-serif ">
      ...
      <div className="flex items-center justify-betwee  space-x-2 gap-5 dark:text-white text-neutral-800">
        <Link to="/files" className="hidden md:block hover:text-orange-700 dark:hover:text-orange-300 cursor-pointer transition-all ease-in-out duration-300" >Media</Link>
